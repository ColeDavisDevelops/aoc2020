...
// let validCount = 0;
// const checkValidity = (min, max, targetLetter, password) => {
//   let counter = 0;
//   for (let i = 0; i < password.length; i++) {
//     if (password[i] === targetLetter) counter++;
//   }
...
//     }
//   });
//   if (checkValidity(min, max, targetLetter, password)) validCount++;
// });
// console.log("part one ans", validCount);

let validCount = 0;

const checkValidity = (firstPos, secondPos, targetLetter, password) => {
  if (
    (password[firstPos - 1] === targetLetter &&
      password[secondPos - 1] !== targetLetter) ||
    (password[firstPos - 1] !== targetLetter &&
      password[secondPos - 1] === targetLetter)
  ) {
    return true;
...
input.forEach((str) => {
  ...
  if (checkValidity(firstPos, secondPos, targetLetter, password)) validCount++;
});
